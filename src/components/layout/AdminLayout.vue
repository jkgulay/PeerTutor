        ...
        <v-col class="d-flex align-center">
          ...
          <v-app-bar-title class="pl-2">
            <RouterLink to="/admin" style="text-decoration: none">
              <span class="font-weight-bold" style="color: #80cbc4">Admin Panel</span>
            </RouterLink>
          </v-app-bar-title>
        </v-col>
        ...
        >
          ...
          <v-list density="compact" nav>
            <v-list-item
              ...
              class="clickable"
            >
              <RouterLink class="text-white text-decoration-none" to="/admin"
                >Admin Dashboard</RouterLink
              >
            </v-list-item>
            <v-list-item prepend-icon="mdi-account" class="clickable">
              <RouterLink class="text-white text-decoration-none" to="/adminuser"
                >Users</RouterLink
              >
            </v-list-item>
      ...
      >
        <v-row justify="center">
          <v-col class="text-center mt-4" cols="12" style="color: #26a69a">
            <strong><p>&copy; 2024 PeerTutor Admin. All Rights Reserved.</p></strong>
          </v-col>
        </v-row>
      </v-footer>
    </v-app>
